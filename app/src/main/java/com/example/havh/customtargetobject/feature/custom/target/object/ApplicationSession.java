...
public class ApplicationSession implements Vuforia.UpdateCallbackInterface {
    ...
    private ApplicationController mSessionControl;
    ...
    public ApplicationSession(ApplicationController sessionControl)
    {
    ...
    public void startAR(int camera)
    {
        ...
        catch (Exception e)
        {
            ...
            vuforiaException = new ApplicationException(
                    ApplicationException.CAMERA_INITIALIZATION_FAILURE,
                    logMessage);
            Log.e(LOGTAG, logMessage);
        }
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mLifecycleLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
