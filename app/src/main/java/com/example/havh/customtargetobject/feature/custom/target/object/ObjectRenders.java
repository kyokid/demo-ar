...
public class ObjectRenders extends Activity implements ApplicationController, SampleAppMenuInterface {
    ...
    // Our renderer:
    private ObjectTargetRender mRenderer;
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer = new ObjectTargetRender(this, vuforiaAppSession);
    ...
    public void onInitARDone(ApplicationException exception)
    {
        ...
        } else
        {
            ...
            if(exception.getCode() == ApplicationException.LOADING_TRACKERS_FAILURE)
            {
